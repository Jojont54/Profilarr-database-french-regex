...
SELECT 'French MULTi Explicit Marker (INTL)',
       ...
       'Matches INTL MULTi releases when an explicit French marker is present before download or when renamed MediaInfo audio contains French and another language, such as [FR+EN]( or [EN+FR](.'
WHERE NOT EXISTS (
